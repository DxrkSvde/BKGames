                ...
                return Q = L(o.default.mark((function e() {
                    ...
                    return o.default.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return a.length > 0 && void 0 !== a[0] ? a[0] : {}, q = JSON.parse(document.getElementById("__NEXT_DATA__").textContent), window.__NEXT_DATA__ = q, K = q.defaultLocale, t = q.assetPrefix || "", r.p = "".concat(t, "/_next/"), _.setConfig({
                                    serverRuntimeConfig: {},
                                    publicRuntimeConfig: q.runtimeConfig || {}
                                }), U = P.getURL(), g.hasBasePath(U) && (U = g.delBasePath(U)), q.scriptLoader && (0, r(3573).zD)(q.scriptLoader), W = new O.default(q.buildId, t), n = function(e) {
                                    var t = f(e, 2),
                                        r = t[0],
                                        n = t[1];
                    ...
                    ! function(e, t) {
                        ...
                        if (t) {
                            if (t.__N) {
                                ...
                                y.isSsr && n === L(y.asPath) && i === L(y.pathname) || y._bps && !y._bps(t) || y.change("replaceState", r, n, Object.assign({}, o, {
                            ...
                            var u = y.pathname,
                                c = y.query;
                            y.changeState("replaceState", O.formatWithValidation({
                                pathname: L(u),
                                query: c
                            }), g.getURL())
                        }
                            ...
                            return o.default.wrap((function(o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 3:
                                        ...
                                        break;
                                    case 19:
                                        if (a._h || (c.isSsr = !1), g.ST && performance.mark("routeChange"), y = a.shallow, _ = void 0 !== y && y, P = a.scroll, E = void 0 === P || P, R = {
                                                shallow: _
                                            }, c._inFlightRoute && c.abortComponentLoad(c._inFlightRoute, R), n = L(k(M(n) ? T(n) : n, a.locale, c.defaultLocale)), j = A(M(n) ? T(n) : n, v.locale), c._inFlightRoute = n, F = m !== v.locale, a._h || !c.onlyAHashChange(j) || F) {
                                            o.next = 36;
                                            break
                                        }
                                        return v.asPath = j, e.events.emit("hashChangeStart", n, R), c.changeState(t, r, n, l({}, a, {
                                            scroll: !1
                                        })), E && c.scrollToHash(j), c.set(v, c.components[v.route], null), e.events.emit("hashChangeComplete", n, R), o.abrupt("return", !0);
                                    case 36:
                                    ...
                                    case 96:
                                        ...
                                        throw new Error((te ? "The provided `href` (".concat(r, ") value is missing query values (").concat(ne.join(", "), ") to be interpolated properly. ") : "The provided `as` value (".concat(J, ") is incompatible with the `href` value (").concat(Y, "). ")) + "Read more: https://nextjs.org/docs/messages/".concat(te ? "href-interpolation-failed" : "incompatible-href-as"));
                                    case 109:
                                        o.next = 112;
                                        break;
                                    case 111:
                                    ...
                                    case 143:
                                        ie = o.sent;
                                    case 144:
                                        return e.events.emit("beforeHistoryChange", n, R), c.changeState(t, r, n, a), a._h && "/_error" === B && 500 === (null === (oe = self.__NEXT_DATA__.props) || void 0 === oe || null === (ae = oe.pageProps) || void 0 === ae ? void 0 : ae.statusCode) && (null === ce || void 0 === ce ? void 0 : ce.pageProps) && (ce.pageProps.statusCode = 500), ye = a.shallow && v.route === Y, be = null !== (ge = a.scroll) && void 0 !== ge ? ge : !ye, we = be ? {
                                            x: 0,
                                            y: 0
                            ...
                            return o.default.wrap((function(o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 11:
                                        ...
                                        break;
                                    case 17:
                                        return (m || y || g) && (b = l.pageLoader.getDataHref({
                                            ...
                                            return m || y ? z(b, l.isSsr, !1, m ? l.sdc : l.sdr, !!m && !s) : l.getInitialProps(v, {
                                                pathname: t,
                                                query: r,
                                                asPath: n,
                                                locale: c,
                        ...
                        return u(o.default.mark((function a() {
                            ...
                            return o.default.wrap((function(o) {
                                for (;;) switch (o.prev = o.next) {
                                    ...
                                    case 27:
                                        return "rewrite" === (m = o.sent).type && (i.pathname = m.resolvedHref, u = m.resolvedHref, c = l({}, c, m.parsedAs.query), f = m.asPath, e = O.formatWithValidation(i)), y = p.removePathTrailingSlash(u), o.next = 32, Promise.all([n.pageLoader._isSsg(y).then((function(t) {
                            ...
                            return o.default.wrap((function(r) {
                                for (;;) switch (r.prev = r.next) {
                                    ...
                                    case 4:
                                        ...
                                        })), c = E.getRoutingItems(e.pages, u), s = !1, l = !0, d = !1, h = void 0, r.prev = 9, v = c[Symbol.iterator]();
                                    case 11:
                                        if (l = (y = v.next()).done) {
                                            r.next = 19;
                                            break
